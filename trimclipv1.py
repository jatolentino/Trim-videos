...
# print(listpath)
# Editing the video, trim the 9 first seconds of every video and store them appending the string 'a' on every video's name. 
# Each video is created inside the folder of the original video
